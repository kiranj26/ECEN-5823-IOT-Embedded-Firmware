...
* @version     0.0.1
* @brief       Header file for SparkFun APDS9960.
*
...
#ifndef SPARKSFUN_APDS9960_H_
#define SPARKSFUN_APDS9960_H_

#include <stdio.h>
#include "stdbool.h"
#include "i2c.h"

/* Debug gesture sensor readings */
